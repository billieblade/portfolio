...
const Achievements = () => {
  ...
  const allAchievements = [
    ...
    },
    {
      ...
      description: "Conduzi campanhas que elegeram 2 de 3 candidatos com estratégias 100% baseadas em dados",
      color: "red"
    },
    {
      icon: <Trophy className="h-8 w-8 text-indigo-500" />,
      title: "Case Varejista Nacional",
      subtitle: "Transformação de Marca",
      description: "Reestruturei comunicação de rede regional que se tornou referência entre concorrentes",
      color: "indigo"
    },
    {
      icon: <Star className="h-8 w-8 text-pink-500" />,
      title: "Redes Sociais Estratégicas",
      subtitle: "Prospecção e Engajamento",
      description: "Transformei redes sociais em ferramenta que trouxe um dos maiores clientes da agência",
      color: "pink"
    }
  ];
